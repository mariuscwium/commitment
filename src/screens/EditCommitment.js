    ...
    if (this.props.location) {
      return (
        <View style={{ flex: 1 }}>
          ...
          <Button onPress={() => this.props.navigation.navigate("FindGym")}>
            <Text>Select gym location</Text>
          </Button>
        </View>
      );
    } else {
        ...
        >
          {props => (
            <View style={{ flex: 1 }}>
              ...
              <Text>
                How much are you willing to pay if you don 't go that many
                times?
              </Text>
              <Picker
                selectedValue={props.values.penalty}
                onValueChange={props.handleChange("penalty")}
              >
